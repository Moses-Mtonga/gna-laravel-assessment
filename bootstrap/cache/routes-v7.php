...
app('router')->setCompiledRoutes(
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::hW0SLjAQmn5HSziI',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::1pR18cqoLvhRbPyP',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::g2qNbi15w7EsRDkz',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::pllQS8womfws8dTO',
          ),
          1 => NULL,
          2 => 
          array (
    ...
    2 => 
    array (
      0 => '{^(?|/farm(?|ers/([^/]++)(?|(*:30)|/edit(*:42)|(*:49))|\\-support/(?|products/(?|destory/([^/]++)(*:98)|update/([^/]++)(*:120))|farmsupport/([^/]++)(?|(*:152)|/edit(*:165)|(*:173))))|/modules/(?|install/([^/]++)(*:212)|delete/([^/]++)(*:235))|/password/reset/([^/]++)(*:268)|/api/v1/(?|farmsupport/([^/]++)(?|(*:310))|loanmanagement/([^/]++)(?|(*:345)))|/loans/loanmanagement/([^/]++)(?|(*:388)|/(?|edit(*:404)|approve(*:419)|re(?|ject(*:436)|paid(*:448)))|(*:458))|/storage/(.*)(*:480))/?$}sDu',
    ),
    3 => 
    array (
      30 => 
  ...
  array (
    ...
    array (
      ...
      'uri' => 'loans/loanmanagement/{id}/approve',
      'action' => 
      array (
        'middleware' => 
        array (
        ...
        'uses' => 'Modules\\LoanManagement\\Http\\Controllers\\LoanManagementController@approve',
        'controller' => 'Modules\\LoanManagement\\Http\\Controllers\\LoanManagementController@approve',
        'namespace' => NULL,
        'prefix' => '/loans',
        'where' => 
        array (
        ),
        'as' => 'loanmanagement.approve',
      ),
      'fallback' => false,
      'defaults' => 
      array (
    ...
    'loanmanagement.reject' => 
    array (
      'methods' => 
      array (
        0 => 'POST',
      ),
      'uri' => 'loans/loanmanagement/{id}/reject',
      'action' => 
      array (
        'middleware' => 
        array (
        ...
        'uses' => 'Modules\\LoanManagement\\Http\\Controllers\\LoanManagementController@reject',
        'controller' => 'Modules\\LoanManagement\\Http\\Controllers\\LoanManagementController@reject',
        'namespace' => NULL,
        'prefix' => '/loans',
        'where' => 
        array (
        ),
        'as' => 'loanmanagement.reject',
      ),
      'fallback' => false,
      'defaults' => 
      array (
    ...
    'loanmanagement.repaid' => 
    array (
      'methods' => 
      array (
        0 => 'POST',
      ),
      'uri' => 'loans/loanmanagement/{id}/repaid',
      'action' => 
      array (
        'middleware' => 
        array (
        ...
        'uses' => 'Modules\\LoanManagement\\Http\\Controllers\\LoanManagementController@repaid',
        'controller' => 'Modules\\LoanManagement\\Http\\Controllers\\LoanManagementController@repaid',
        'namespace' => NULL,
        'prefix' => '/loans',
        'where' => 
        array (
        ),
        'as' => 'loanmanagement.repaid',
      ),
      'fallback' => false,
      'defaults' => 
      array (
    ...
    array (
      ...
      array (
        'uses' => 'O:55:"Laravel\\SerializableClosure\\UnsignedSerializableClosure":1:{s:12:"serializable";O:46:"Laravel\\SerializableClosure\\Serializers\\Native":5:{s:3:"use";a:3:{s:4:"disk";s:5:"local";s:6:"config";a:4:{s:6:"driver";s:5:"local";s:4:"root";s:93:"C:\\Users\\USER\\Desktop\\git projects\\Personal\\GNA-farmers-management-system\\storage\\app/private";s:5:"serve";b:1;s:5:"throw";b:0;}s:12:"isProduction";b:0;}s:8:"function";s:323:"function (\\Illuminate\\Http\\Request $request, string $path) use ($disk, $config, $isProduction) {
                ...
                }";s:5:"scope";s:47:"Illuminate\\Filesystem\\FilesystemServiceProvider";s:4:"this";N;s:4:"self";s:32:"0000000000000ab20000000000000000";}}',
        'as' => 'storage.local',
      ),
      'fallback' => false,
      'defaults' => 
